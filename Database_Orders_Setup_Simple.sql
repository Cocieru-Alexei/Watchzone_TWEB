-- Simplified Database setup script for WatchZone order functionality
-- Run this script to create the Orders and OrderItems tables without foreign key constraints
...
PRINT 'Note: Foreign key constraints were not added to avoid dependency issues.';
PRINT 'You can add them manually later if needed.';
GO 